 ...
 */
final class Version20190906223210 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pizza (id INT AUTO_INCREMENT NOT NULL, school_id INT DEFAULT NULL, teacher_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, UNIQUE INDEX UNIQ_CFDD826FC32A47EE (school_id), UNIQUE INDEX UNIQ_CFDD826F41807E1D (teacher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pizza ADD CONSTRAINT FK_CFDD826F41807E1D FOREIGN KEY (teacher_id) REFERENCES teacher (id)');
        $this->addSql('ALTER TABLE pizza ADD CONSTRAINT FK_CFDD826FC32A47EE FOREIGN KEY (school_id) REFERENCES school (id)');
    }
}
